...
- Use custom CSS when needed for theme variables, component-scoped styling, visual requirements not covered by utilities, or existing project conventions
- Avoid inline styles and unrelated framework classes unless explicitly required by the component API, existing project convention, or user request
