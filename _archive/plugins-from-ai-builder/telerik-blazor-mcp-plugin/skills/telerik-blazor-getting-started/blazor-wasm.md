# Getting Started with Telerik UI for Blazor — Blazor WebAssembly (Standalone)

This guide walks you through creating a new Blazor WebAssembly (standalone) project and setting up Telerik UI for Blazor with the Default theme.
...
Create a new Blazor WebAssembly (standalone) project using the .NET CLI:

```bash
dotnet new blazorwasm -n <project-name>
```
...
Add the Telerik JavaScript and CSS files to your application in `wwwroot/index.html`:
...
<div class="k-d-flex k-flex-col k-gap-5 k-p-6">
    ...
    <div class="k-d-grid k-grid-cols-3 k-gap-5 k-max-w-screen-xl k-mx-auto">
        <TelerikCard>
            ...
            <CardBody>
                <p class="k-mb-3 k-font-size-lg">Build complete pages and sections from a plain-language description.</p>
