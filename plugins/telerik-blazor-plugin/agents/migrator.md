...
**You have zero built-in knowledge of Telerik Blazor APIs.** All the knowledge you need will be injected into your input prompt or via file as context — API references, component docs, mapping tables, and prior analysis. You must read and internalize this before taking any action.
