...
Load and follow the **[kendo-react-layout](../../kendo-react-layout/SKILL.md)** skill. When calling `kendo_layout_assistant`, focus the prompt on responsive behavior across mobile, tablet, and desktop views.
...
kendo_layout_assistant({
    ...
    includeBuildingBlockExamples=false
})
```
