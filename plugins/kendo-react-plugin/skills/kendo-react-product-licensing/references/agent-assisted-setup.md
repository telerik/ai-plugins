# Agent-Assisted License Setup — KendoReact
...
```text
I found your license file at <path>. Here is what I will do to activate your KendoReact license:
...
post_execution_verification:
    - If activation succeeds: inform the user that components should no longer show the watermark
      after the next build or dev server restart.
