...
description: Use this agent when building, implementing, or extending React application features using KendoReact components and the Progress Design System. This is the primary development agent — trigger it when the user wants to create new UI components, build application features, implement data-driven interfaces, or integrate KendoReact capabilities into their project. Examples:

<example>
Context: User needs to build a data management screen with a grid and filters.
user: "Build me a product management page with search, filters, and a data grid"
assistant: "I'll use the kendo-developer agent to build this with KendoReact."
<commentary>
Building a complete feature with KendoReact components is the core use case for kendo-developer.
</commentary>
</example>

<example>
Context: User wants to add a charting dashboard to their React app.
user: "Create an analytics dashboard with sales charts and KPIs"
assistant: "Let me use kendo-developer to implement this with KendoReact Charts and layout components."
<commentary>
Dashboard implementation using KendoReact is a strong trigger for kendo-developer.
</commentary>
</example>

<example>
Context: User has a design mockup and wants KendoReact implementation.
user: "Implement this form layout using KendoReact — it has name, email, date range, and a dropdown"
assistant: "I'll use kendo-developer to implement this form with the appropriate KendoReact inputs."
<commentary>
Form implementation using KendoReact inputs triggers kendo-developer.
</commentary>
</example>

<example>
Context: User wants to integrate E2E tests for their KendoReact UI.
user: "Add E2E tests for my KendoReact Grid with filters"
assistant: "I'll build the grid with kendo-developer, then hand off to the kendo-tester agent to generate E2E tests."
<commentary>
kendo-developer builds the component, then hands off testing to the kendo-tester agent.
</commentary>
</example>

<example>
Context: User opens a React project that has @progress/kendo-react-* in package.json and asks to add a feature.
user: "Add a user profile page with editable fields"
assistant: "I see KendoReact is already installed. I'll use the kendo-developer agent to build the profile page with KendoReact form components."
<commentary>
Project already uses KendoReact (detected in package.json). Any new UI feature should be built with KendoReact. Proactively trigger kendo-developer.
</commentary>
</example>

<example>
Context: kendo-migrator just finished converting components and the newly migrated code needs adjustments.
user: "The migrated Grid is missing sorting and filtering — add them"
assistant: "I'll use the kendo-developer agent to add sorting and filtering to the Grid."
<commentary>
After migration, extending or fixing KendoReact components falls to kendo-developer. Proactively trigger when post-migration work is needed.
</commentary>
</example>

<example>
Context: User is building a React app and the assistant detects the project uses KendoReact packages.
user: "I need a sidebar navigation with collapsible sections"
assistant: "Your project uses KendoReact — I'll use the kendo-developer agent to build the sidebar with KendoReact layout components."
<commentary>
When the project has KendoReact dependencies and the user asks to build any UI, proactively use kendo-developer instead of plain HTML/CSS.
</commentary>
</example>
