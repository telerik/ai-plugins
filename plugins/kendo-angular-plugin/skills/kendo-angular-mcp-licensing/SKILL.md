...
description: >
  ...
  env var for MCP" / "kendo-angular-mcp PERMISSION_DENIED" / "MCP tools not
  ...
  @progress/kendo-angular-mcp. Use when MCP tool calls return PERMISSION_DENIED
  ...
  are project licensing issues, route to kendo-angular-product-licensing. Do NOT
  use for first-time install or onboarding — route to
  kendo-angular-getting-started. Scoped to Kendo UI for Angular.
---
